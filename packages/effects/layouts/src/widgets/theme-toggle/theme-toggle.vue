...
import { OceanTooltip, ToggleGroup, ToggleGroupItem } from '@ocean-core/shadcn-ui';
...
<template>
  <div>
    <OceanTooltip :disabled="!shouldOnHover" side="bottom">
      <template #trigger>
      ...
      <ToggleGroup
        ...
        type="single"
        variant="outline"
        @update:model-value="(val) => updatePreferences({ theme: { mode: val as ThemeModeType } })"
      >
