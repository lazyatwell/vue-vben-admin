...
import { SearchX, X } from '@ocean/icons';
import { $t } from '@ocean/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@ocean/utils';

import { OceanIcon, OceanScrollbar } from '@ocean-core/shadcn-ui';
import { isHttpUrl } from '@ocean-core/shared/utils';
  ...
  <OceanScrollbar>
    <div class="!flex h-full justify-center px-2 sm:max-h-[450px]">
      ...
      <ul v-show="searchResults.length > 0" class="w-full">
        ...
        >
          <OceanIcon :icon="item.icon" class="mr-2 size-5 flex-shrink-0" fallback />
