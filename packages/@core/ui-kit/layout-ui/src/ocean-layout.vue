...
import type { OceanLayoutProps } from './ocean-layout';

import { computed, ref, watch } from 'vue';

import { SCROLL_FIXED_CLASS, useLayoutFooterStyle, useLayoutHeaderStyle } from '@ocean-core/composables';
import { Menu } from '@ocean-core/icons';
...
interface Props extends OceanLayoutProps {}
...
const mainStyle = computed(() => {
  ...
  if (
    ...
    const isSideNavEffective =
      (isSidebarMixedNav.value || isHeaderMixedNav.value) && sidebarExpandOnHover.value && sidebarExtraVisible.value;
      ...
      >
        ...
        >
          ...
          <template #toggle-button>
            <OceanIconButton v-if="showHeaderToggleButton" class="my-0 mr-1 rounded-md" @click="handleHeaderToggle">
              <Menu class="size-4" />
            </OceanIconButton>
          </template>
